## Python Script "object_rename_title"
...
##parameters=
##title=Show the rename title form for an object
...
url = '%s/folder_rename_title_form?orig_template=%s&%s=%s' % (context.absolute_url(),
                                                              orig_template,
                                                              pathName,
                                                              safePath)
