...
class Migrate_To_0_2(Migrator):
    ...
    def _configure_plonegroup(self):
        ...
        uids = []
        brains = pcat(
            path={"query": "/".join(own_orga.getPhysicalPath()), "depth": 1},
        ...
        for brain in brains:
            ...
            uids.append(dep.UID())
            services_brains = pcat(
                path={"query": "/".join(dep.getPhysicalPath()), "depth": 1},
                portal_type="organization",
                sort_on="getObjPositionInParent",
            )
    ...
    def _configure_product(self):
        ...
        self.portal.portal_setup.runImportStepFromProfile(
            "profile-imio.dms.mail:examples", "imiodmsmail-configureDocumentViewer"
        )
    ...
    def run(self):
        ...
        self.portal.portal_setup.runImportStepFromProfile("profile-imio.dms.mail:default", "workflow")
