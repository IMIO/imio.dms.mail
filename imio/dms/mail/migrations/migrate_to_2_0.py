...
class Migrate_To_2_0(Migrator):
    ...
    def manage_localroles(self):
        ...
        if "static_config" in lr:
            ...
            if (
                ...
                and "DmsFile Contributor" not in lrsc["created"]["encodeurs"]["roles"]
            ):
    ...
    def update_collections(self):
        """No more applied"""
        for folder, fid, colid in [
            (self.imf, "mail-searches", "all_mails"),
            (self.omf, "mail-searches", "all_mails"),
    ...
    def update_site(self):
        ...
        if api.content.get_state(self.omf) != "internally_published":
            do_transitions(self.omf, ["show_internally"])
        # add group
        ...
        for perm in (
            ...
            if "Site Administrator" not in [
                dic["name"] for dic in self.portal.rolesOfPermission(perm) if dic["selected"] == "SELECTED"
            ]:
        ...
        add_message(
            ...
            u"version 2.0</a>, ainsi que d'autres documentations liées.</p>",
        ...
        if "dmsoutgoingmail.back_to_agent|" not in val:
            val += [
                ...
                "dmsoutgoingmail.back_to_print|",
                "dmsoutgoingmail.back_to_be_signed|",
                "dmsoutgoingmail.back_to_scanned|",
            ]
            api.portal.set_registry_record(
                "imio.actionspanel.browser.registry.IImioActionsPanelConfig.transitions", val
            )
        # update front-page
    ...
    def configure_dashboard(self):
        ...
        col_folder = add_db_col_folder(self.omf, "mail-searches", _("Outgoing mail searches"), _("Outgoing mails"))
        alsoProvides(col_folder, INextPrevNotNavigable)
        ...
        configure_faceted_folder(
            self.omf, xml="default_dashboard_widgets.xml", default_UID=col_folder["all_mails"].UID()
        )
