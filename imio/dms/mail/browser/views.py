...
class FolderDuplicateForm(Form):
    ...
    def update(self):
        """Handle fields."""
        folder_fields = api.portal.get_registry_record("folder_fields", IImioClassificationConfig, [])
        ...
        to_show = api.portal.get_registry_record("folder_duplicate_display_fields", IImioClassificationConfig, [])
        to_true = api.portal.get_registry_record("folder_duplicate_true_default_values", IImioClassificationConfig, [])
    ...
    def updateWidgets(self, prefix=None):
        ...
        to_show = api.portal.get_registry_record("folder_duplicate_display_fields", IImioDmsMailConfig, [])
        for term in folder_duplicate_fields:
    ...
    def handleApply(self, action):
        ...
        odm_utils = getMultiAdapter((self.context, self.request), name="various-utils")
        duplicated_folder = odm_utils.duplicate_folder(
