...
class TestSteps(unittest.TestCase):
    ...
    def test_create_persons_from_users(self):
        ...
        self.assertListEqual(pf.objectIds(), ['chef', 'agent', 'agent1'])
        ...
        # person
        self.assertListEqual(pf.objectIds(), ['chef', 'agent', 'agent1', 'newuser'])
        nu_p = pf['newuser']
        ...
        self.portal.portal_setup.runImportStepFromProfile('imio.dms.mail:singles',
                                                          'imiodmsmail-create-persons-from-users-inverted',
                                                          run_dependencies=False)
        self.assertListEqual(pf.objectIds(), ['chef', 'agent', 'agent1', 'newuser_renamed'])
