...
def configure_rolefields(context):
    ...
    roles_config = {'localroleconfig': {
        ...
        'in_treatment': {'dir_general': ['Contributor', 'Editor', 'Reviewer', 'IM Field Writer',
                                         'IM Treating Group Writer'],
                         'encodeurs': ['Reader']},
        'closed': {'dir_general': ['Contributor', 'Editor', 'Reviewer', 'IM Field Writer', 'IM Treating Group Writer'],
                   'encodeurs': ['Reader']},
    }, 'treating_groups': {
        #'created': {},
        #'proposed_to_manager': {},
        'proposed_to_service_chief': {'validateur': ['Contributor', 'Editor', 'Reviewer', 'IM Treating Group Writer']},
