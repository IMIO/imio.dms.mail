...
if ! test -f locales/plone.pot || [ "$1" == "rebuild-plone" ]; then
    ...
    i18ndude rebuild-pot --pot locales/plone.pot --create plone profiles/default/workflows/incomingmail_workflow/ profiles/default/workflows/outgoingmail_workflow/ profiles/default/workflows/sign_request_workflow/
fi
